...
path='/Users/nasimeh/Documents/distributed_GCN-main-6/Oct12_2023/log/Hypermaxcut_syn_new_rev1_2_plot.log'
with open(path) as f:
    Log=f.readlines()
...
path='/Users/nasimeh/Documents/distributed_GCN-main-6/Oct12_2023/log/Hypermaxcut_syn_new_Rand_l2_rev1_s_2_plot.log'
...
plt.savefig('/Users/nasimeh/Documents/distributed_GCN-main-6/Oct12_2023/res/plots/Hypermaxcut_syn_rev1_1r.png')
plt.show()
...
plt.savefig('/Users/nasimeh/Documents/distributed_GCN-main-6/Oct12_2023/res/plots/Hypermaxcut_syn_time_rev1_1r.png')
plt.show()
...
#APS
path='../log/Hypermaxcut_APS_3Y_f2.log'
with open(path) as f:
    Log=f.readlines()
...
path='../log/Hypermaxcut_APS_3Y_Rand_l.log'
...
path='../log/Hypermaxcut_APS_3Y_GD3.log'
with open(path) as f:
    Log=f.readlines()
...
path='../log/Hypermaxcut_APS_3Y_GD.log'
with open(path) as f:
    Log=f.readlines()
