...
y_axis2=np.array([log_r[name]['res']/log_d[name]['n'] for name in log_d])
...
plt.savefig('/Users/nasimeh/Documents/distributed_GCN-main-6/Oct12_2023/res/plots/Task3_rev1.pdf')
plt.show()
...
plt.savefig('./res/plots/Task_time_rev1.pdf')
plt.show()
