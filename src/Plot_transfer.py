...
path='/Users/nasimeh/Documents/distributed_GCN-main-6/Oct12_2023/log/maxind_reg_d3_filtered.log'
with open(path) as f:
    Log=f.readlines()
...
for lines in Log:
    ...
    res_th=float(temp3[1][11:-4])
    log_d[name]={}
    log_d[name]['time']=time
    log_d[name]['res'] = abs(int(res))
    log_d[name]['res_th'] = abs(int(res_th))
    path="/Users/nasimeh/Documents/distributed_GCN-main-6/Oct12_2023/data/maxind_data/random_regular/d3/"+name
    with open(path) as f:
        file = f.read()
    lines = file.split('\n')
    info = lines[0].split(' ')
...
path='/Users/nasimeh/Documents/distributed_GCN-main-6/Oct12_2023/log/maxind_reg_d3_transfer_fewshot4.log'
...
y_axis=np.array([log_d[name]['res_th']/log_d[name]['n'] for name in log_d])
...
plt.ylabel('Independent Set Size over the Number of Nodes')
plt.ylim(0.35,0.5)
plt.xlabel('Number of Nodes')
plt.legend(loc='upper right')
plt.savefig('/Users/nasimeh/Documents/distributed_GCN-main-6/Oct12_2023/res/plots/maxind_reg_d3_transfer_rev1.tiff')
plt.show()
...
plt.savefig('/Users/nasimeh/Documents/distributed_GCN-main-6/Oct12_2023/res/plots/maxind_reg_d3_transfer_time_rev1.tiff')
plt.show()
