...
#os.chdir(path)
for n in N:
    for pow in np.linspace(1.2,3,10):
        ...
        path2 = "/Users/nasimeh/Documents/distributed_GCN-main-6/data/maxind_data/powerlawn_n/"+str(n)+"/"
        name2 = 'G_power_random' + str(n) + '_' + str(pow) + '_' + str(p) + '.txt'
        path3 = "/Users/nasimeh/Documents/distributed_GCN-main-6/data/maxind_data/powerlawn_n/"+str(n)+"/"

        name3 = 'G_power_reg' + str(n) + '_' + str(pow) + '_' + str(d) + '.txt'
        path4 = "/Users/nasimeh/Documents/distributed_GCN-main-6/data/maxind_data/powerlawn_n/"+str(n)+"/"
