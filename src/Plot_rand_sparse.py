...
with open(path+'maxind_rand_200_l_sparse8.log') as f:
    Log=f.readlines()
...
plt.xlabel('ln(p)')
plt.legend(loc='upper right')
plt.savefig("/Users/nasimeh/Documents/distributed_GCN-main-6/Oct12_2023/res/plots/maxind_rand_sparse2.pdf")
plt.show()
